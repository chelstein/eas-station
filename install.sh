...
{
    printf '\033[2J\033[H'
    printf '\033[1;34m  EAS Station — Bare Metal Installer\033[0m\n'
...
DATABASE_URL=postgresql+psycopg2://eas_station:$DB_PASSWORD@127.0.0.1:5432/alerts
...
show_celebration "Installation completed successfully!"
