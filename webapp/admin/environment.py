...
ENV_CATEGORIES = {
    ...
    'eas': {
        ...
        'variables': [
            ...
            },
            {
                ...
                'label': 'Audio Scan Interval (seconds)',
                'type': 'number',
                'default': '60',
                'description': 'How often to scan audio sources for EAS tones',
                'min': 10,
                'max': 600,
                'category': 'eas_enabled',
            },
            {
                ...
                'type': 'number',
                'default': '3',
                'description': 'Maximum number of simultaneous EAS audio scans',
                'min': 1,
                'max': 10,
                'category': 'eas_enabled',
            },
    ...
    'tts': {
        'name': 'Text-to-Speech',
        'icon': 'fa-volume-up',
        'description': 'TTS provider configuration for alert audio generation',
        'variables': [
            {
                'key': 'EAS_TTS_PROVIDER',
                'label': 'TTS Provider',
                'type': 'select',
                'options': ['pyttsx3', 'azure', 'azure_openai'],
                'default': 'pyttsx3',
                'description': 'Text-to-speech provider: pyttsx3 (offline), azure (Azure Speech), azure_openai (Azure OpenAI)',
            },
            {
                ...
                'type': 'json',
                'rows': 6,
                'description': 'JSON configuration for Azure OpenAI TTS (endpoint, key, model, voice, speed)',
                'placeholder': '{"endpoint": "https://your-resource.openai.azure.com/openai/deployments/tts-hd/audio/speech?api-version=2024-02-15-preview", "key": "your-api-key", "model": "tts-1-hd", "voice": "alloy", "speed": 1.0}',
            },
        ],
    },
    'certbot': {
        ...
        'icon': 'fa-lock',
        'description': "Let's Encrypt SSL certificate management with Certbot",
        'variables': [
            {
                'key': 'DOMAIN_NAME',
                'label': 'Domain Name',
                'type': 'text',
                'description': 'Your domain name for SSL certificate (e.g., eas.example.com)',
            ...
            },
            {
                ...
                'options': ['0', '1'],
                'default': '0',
                'description': "Use Let's Encrypt staging server for testing (prevents rate limiting)",
            },
        ],
    },
    'zigbee': {
    ...
    'system': {
        ...
        'variables': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': '/opt/eas-station/backups',
                'description': 'Directory for system backups',
            },
            {
                'key': 'WEB_ACCESS_LOG',
                'label': 'Web Access Log Path',
                'type': 'text',
                'default': '/var/log/eas-station/access.log',
                'description': 'Path to web server access log file',
            },
        ],
    },
