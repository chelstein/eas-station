...
# Language logo definitions as inline SVG
# These are official programming language logos rendered as inline SVG
# to avoid external CDN dependencies and ensure consistent rendering
LANGUAGE_LOGOS = {
    'Python': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#3776AB" style="vertical-align: middle; margin-right: 6px;"><path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05-.05-1.23.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.24-.01h.16l.06.01h8.16v-.83H6.18l-.01-2.75-.02-.37.05-.34.11-.31.17-.28.25-.26.31-.23.38-.2.44-.18.51-.15.58-.12.64-.1.71-.06.77-.04.84-.02 1.27.05zm-6.3 1.98l-.23.33-.08.41.08.41.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.41-.08-.41-.23-.33-.33-.22-.41-.09-.41.09zm13.09 3.95l.28.06.32.12.35.18.36.27.36.35.35.47.32.59.28.73.21.88.14 1.04.05 1.23-.06 1.23-.16 1.04-.24.86-.32.71-.36.57-.4.45-.42.33-.42.24-.4.16-.36.09-.32.05-.24.02-.16-.01h-8.22v.82h5.84l.01 2.76.02.36-.05.34-.11.31-.17.29-.25.25-.31.24-.38.2-.44.17-.51.15-.58.13-.64.09-.71.07-.77.04-.84.01-1.27-.04-1.07-.14-.9-.2-.73-.25-.59-.3-.45-.33-.34-.34-.25-.34-.16-.33-.1-.3-.04-.25-.02-.2.01-.13v-5.34l.05-.64.13-.54.21-.46.26-.38.3-.32.33-.24.35-.2.35-.14.33-.1.3-.06.26-.04.21-.02.13-.01h5.84l.69-.05.59-.14.5-.21.41-.28.33-.32.27-.35.2-.36.15-.36.1-.35.07-.32.04-.28.02-.21V6.07h2.09l.14.01zm-6.47 14.25l-.23.33-.08.41.08.41.23.33.33.23.41.08.41-.08.33-.23.23-.33.08-.41-.08-.41-.23-.33-.33-.23-.41-.08-.41.08z"/></svg>',
    'HTML': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#E34F26" style="vertical-align: middle; margin-right: 6px;"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/></svg>',
    'JavaScript': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#F7DF1E" style="vertical-align: middle; margin-right: 6px;"><path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-1.065-2.834-1.034l-.705.089c-.676.165-1.32.525-1.71 1.005-1.14 1.291-.811 3.541.569 4.471 1.365 1.02 3.361 1.244 3.616 2.205.24 1.17-.87 1.545-1.966 1.41-.811-.18-1.26-.586-1.755-1.336l-1.83 1.051c.21.48.45.689.81 1.109 1.74 1.756 6.09 1.666 6.871-1.004.029-.09.24-.705.074-1.65l.046.067zm-8.983-7.245h-2.248c0 1.938-.009 3.864-.009 5.805 0 1.232.063 2.363-.138 2.711-.33.689-1.18.601-1.566.48-.396-.196-.597-.466-.83-.855-.063-.105-.11-.196-.127-.196l-1.825 1.125c.305.63.75 1.172 1.324 1.517.855.51 2.004.675 3.207.405.783-.226 1.458-.691 1.811-1.411.51-.93.402-2.07.397-3.346.012-2.054 0-4.109 0-6.179l.004-.056z"/></svg>',
    'CSS': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#1572B6" style="vertical-align: middle; margin-right: 6px;"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"/></svg>',
    'Markdown': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#083fa1" style="vertical-align: middle; margin-right: 6px;"><path d="M22.27 19.385H1.73A1.73 1.73 0 010 17.655V6.345a1.73 1.73 0 011.73-1.73h20.54A1.73 1.73 0 0124 6.345v11.308a1.73 1.73 0 01-1.73 1.731zM5.769 15.923v-4.5l2.308 2.885 2.307-2.885v4.5h2.308V8.078h-2.308l-2.307 2.885-2.308-2.885H3.46v7.847zM21.232 12h-2.309V8.077h-2.307V12h-2.308l3.461 4.039z"/></svg>',
    'Shell': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#4EAA25" style="vertical-align: middle; margin-right: 6px;"><path d="M4.87 17.545l3.09-3.09c.19-.19.19-.5 0-.69l-3.09-3.09c-.19-.19-.5-.19-.69 0l-.69.69c-.19.19-.19.5 0 .69l1.96 1.96-1.96 1.96c-.19.19-.19.5 0 .69l.69.69c.19.19.5.19.69 0zm7.13 1.455h-4c-.28 0-.5.22-.5.5v1c0 .28.22.5.5.5h4c.28 0 .5-.22.5-.5v-1c0-.28-.22-.5-.5-.5zM24 4v16c0 1.1-.9 2-2 2H2c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h20c1.1 0 2 .9 2 2zm-2 0H2v16h20V4z"/></svg>',
    'YAML': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#CB171E" style="vertical-align: middle; margin-right: 6px;"><path d="M4.06 0c-.75 0-1.46.34-1.93.93L.11 3.48c-.22.27-.13.67.2.84l1.04.54c.32.17.72.1.94-.17l1.21-1.52 1.22 1.52c.22.27.62.34.94.17l1.04-.54c.33-.17.42-.57.2-.84L4.99.93C4.52.34 3.81 0 4.06 0zm15.88 0c.75 0 1.46.34 1.93.93l2.02 2.55c.22.27.13.67-.2.84l-1.04.54c-.32.17-.72.1-.94-.17l-1.21-1.52-1.22 1.52c-.22.27-.62.34-.94.17l-1.04-.54c-.33-.17-.42-.57-.2-.84L19.01.93C19.48.34 20.19 0 19.94 0zM12 4.19l-3.99 11.62h2.14L11.05 13h1.9l.9 2.81h2.14L12 4.19zm0 3.67l.64 2.02h-1.28l.64-2.02zM4.66 13L3 17.81l-1.66-4.81H-.04L2.29 20h1.42L6.04 13H4.66zm13.68 0L16.68 20h1.42L20.43 13h-1.38l-1.66 4.81L15.72 13h-1.38z"/></svg>',
    'SQL': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#4169E1" style="vertical-align: middle; margin-right: 6px;"><path d="M12 0C5.4 0 0 1.07 0 2.4v19.2c0 1.33 5.4 2.4 12 2.4s12-1.07 12-2.4V2.4C24 1.07 18.6 0 12 0zm0 2.4c5.52 0 9.6.897 9.6 1.2 0 .303-4.08 1.2-9.6 1.2S2.4 3.903 2.4 3.6c0-.303 4.08-1.2 9.6-1.2zM2.4 7.2c1.68.657 5.136 1.2 9.6 1.2s7.92-.543 9.6-1.2v3.6c0 .303-4.08 1.2-9.6 1.2S2.4 11.103 2.4 10.8V7.2zm0 6c1.68.657 5.136 1.2 9.6 1.2s7.92-.543 9.6-1.2v3.6c0 .303-4.08 1.2-9.6 1.2s-9.6-.897-9.6-1.2v-3.6zm0 6c1.68.657 5.136 1.2 9.6 1.2s7.92-.543 9.6-1.2v2.4c0 .303-4.08 1.2-9.6 1.2s-9.6-.897-9.6-1.2v-2.4z"/></svg>',
    'SVG': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#FFB13B" style="vertical-align: middle; margin-right: 6px;"><path d="M7.466 0L0 7.466v9.068L7.466 24h9.068L24 16.534V7.466L16.534 0H7.466zm4.386 2.867c.888 0 1.61.722 1.61 1.61 0 .889-.722 1.61-1.61 1.61-.889 0-1.61-.721-1.61-1.61 0-.888.721-1.61 1.61-1.61zm-2.867 7.2c1.066 0 1.932.867 1.932 1.933s-.866 1.933-1.932 1.933c-1.067 0-1.933-.867-1.933-1.933s.866-1.933 1.933-1.933zm6.4 0c1.066 0 1.932.867 1.932 1.933s-.866 1.933-1.932 1.933c-1.067 0-1.933-.867-1.933-1.933s.866-1.933 1.933-1.933zm-3.2 6.4c1.333 0 2.416 1.083 2.416 2.417s-1.083 2.416-2.416 2.416-2.417-1.082-2.417-2.416S10.852 16.467 12.185 16.467z"/></svg>',
    'JSON': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#5C6BC0" style="vertical-align: middle; margin-right: 6px;"><path d="M3.5 4c-1.38 0-2.5 1.12-2.5 2.5v11C1 18.88 2.12 20 3.5 20h17c1.38 0 2.5-1.12 2.5-2.5v-11C23 5.12 21.88 4 20.5 4h-17zm0 2h17c.28 0 .5.22.5.5v11c0 .28-.22.5-.5.5h-17c-.28 0-.5-.22-.5-.5v-11c0-.28.22-.5.5-.5zM7 9v6H6V9h1zm3 0c.55 0 1 .45 1 1v4c0 .55-.45 1-1 1s-1-.45-1-1v-4c0-.55.45-1 1-1zm4 0v2h1c.55 0 1 .45 1 1v2h-1v-2h-1v2h-1V9h2zm4 0c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1h-1V9h1z"/></svg>',
    'XML': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#005FAF" style="vertical-align: middle; margin-right: 6px;"><path d="M6 3l-4 4 4 4 1.5-1.5L5 7l2.5-2.5L6 3zm12 0l-1.5 1.5L19 7l-2.5 2.5L18 11l4-4-4-4zM8.5 9L6 21h2l2.5-12h-2zm5 0L11 21h2l2.5-12h-2z"/></svg>',
    'Text': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#607D8B" style="vertical-align: middle; margin-right: 6px;"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',
    'Other': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#9E9E9E" style="vertical-align: middle; margin-right: 6px;"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg>',
}
...
def generate_html(stats: Dict) -> str:
    ...
    # Helper function to get logo HTML for a language
    def get_logo_html(lang: str) -> str:
...
<head>
    ...
    <style>
        ...
        .architecture-card ul li strong {{
            color: var(--text-color);
        }}
...
<body>
    ...
    for lang, counts in sorted_lines:
        if counts['total'] > 0:
            ...
            html += f'''
                        <tr>
                            <td><strong>{logo_html}{lang}</strong></td>
