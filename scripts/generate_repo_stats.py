...
def generate_html(stats: Dict) -> str:
    ...
    # Mapping of language names to inline SVG logos
    # Using simple, recognizable SVG icons for each language
    type_logos = {
        ...
        'JSON': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#000000" style="vertical-align: middle; margin-right: 6px;"><path d="M3.5 4c-1.38 0-2.5 1.12-2.5 2.5v11C1 18.88 2.12 20 3.5 20h17c1.38 0 2.5-1.12 2.5-2.5v-11C23 5.12 21.88 4 20.5 4h-17zm0 2h17c.28 0 .5.22.5.5v11c0 .28-.22.5-.5.5h-17c-.28 0-.5-.22-.5-.5v-11c0-.28.22-.5.5-.5zM7 9v6H6V9h1zm3 0c.55 0 1 .45 1 1v4c0 .55-.45 1-1 1s-1-.45-1-1v-4c0-.55.45-1 1-1zm4 0v2h1c.55 0 1 .45 1 1v2h-1v-2h-1v2h-1V9h2zm4 0c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1h-1V9h1z"/></svg>',
        ...
        'Text': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#333333" style="vertical-align: middle; margin-right: 6px;"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',
        'Other': '<svg viewBox="0 0 24 24" width="20" height="20" fill="#777777" style="vertical-align: middle; margin-right: 6px;"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg>',
    }
    
    # Helper function to get logo HTML for a language
    def get_logo_html(lang: str) -> str:
        """Generate inline SVG HTML for language logo."""
        return type_logos.get(lang, type_logos['Other'])
