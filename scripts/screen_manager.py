...
SNAPSHOT_SCREEN_TEMPLATE = {
    ...
    "template_data": {
        "clear": True,
        "elements": [
            # Header banner: full-width inverted bar with title and live clock
            {"type": "rectangle", "x": 0, "y": 0, "width": 128, "height": 12, "filled": True},
            {"type": "text", "text": "SYSTEM STATUS", "x": 4, "y": 1, "font": "small", "invert": True},
            {
                "type": "text",
                "text": "{now.time_24}",
                "x": 124, "y": 1,
                "font": "small", "invert": True,
                "align": "right", "max_width": 30, "overflow": "trim",
            },
            # CPU row (y=14): label | bar (75px) | percentage right-aligned
            {"type": "text", "text": "CPU", "x": 2, "y": 14, "font": "small"},
            {
                "type": "bar",
                "value": "{status.system_resources.cpu_usage_percent}",
                "x": 26, "y": 15, "width": 75, "height": 9, "border": True,
            },
            {
                "type": "text",
            ...
            {"type": "text", "text": "MEM", "x": 2, "y": 26, "font": "small"},
            {
                ...
                "x": 26, "y": 27, "width": 75, "height": 9, "border": True,
            },
            {
                "type": "text",
            ...
            {"type": "text", "text": "DSK", "x": 2, "y": 38, "font": "small"},
            {
                ...
                "x": 26, "y": 39, "width": 75, "height": 9, "border": True,
            },
            {
                "type": "text",
            ...
            # Footer: thin divider then status summary + date
            {"type": "hline", "x": 0, "y": 51, "width": 128},
            {
                "type": "text",
