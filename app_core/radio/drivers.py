...
class _SoapySDRReceiver(ReceiverInterface):
    ...
    def _compute_spectrum(self, samples, numpy_module) -> None:
        ...
        samples_for_fft = samples[start_idx:start_idx + self._fft_size]
        ...
        samples_for_fft = samples_for_fft - numpy_module.mean(samples_for_fft)
        
        windowed = samples_for_fft * self._window
